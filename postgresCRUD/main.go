...
func main(){
	post := Post{Content: "NBA 2019", Author: "Stephen Curry"}
	post.Create()

	comment := Comment{Content: "Best League!", Author: "Steve Kerr", Post: &post}
	comment.Create()
	...
	fmt.Println(readPost.Author)
	fmt.Println(readPost.Comments[0].Author)
